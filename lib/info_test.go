...
func TestGetInfoPlanEmptyTable(t *testing.T) {
	html := `<html><body><table>
<tr><th>Plan name</th><th>Client</th><th>Creation Date</th></tr>
<tr><td>testenv1</td><td>client1</td><td>05-26-2026</td></tr>
<tr><th>Vm name</th><th>Status</th><th>Ip</th></tr>
	...
	if len(info.Nodes) != 0 {
		t.Errorf("Expected 0 nodes, got %d", len(info.Nodes))
	}
...
func TestGetInfoPlanMinimalHTML(t *testing.T) {
	...
	if len(info.Nodes) != 0 {
		t.Errorf("Expected 0 nodes for non-table HTML, got %d", len(info.Nodes))
	}
}

func TestGetInfoPlanServerError(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, _ *http.Request) {
...
func TestGetInfoPlanMultipleIPs(t *testing.T) {
	html := `<html><body><table>
<tr><th>Plan name</th><th>Client</th><th>Creation Date</th></tr>
<tr><td>testenv1</td><td>client1</td><td>05-26-2026</td></tr>
<tr><th>Vm name</th><th>Status</th><th>Ip</th></tr>
<tr><td>testenv1-installer</td><td>up</td><td>192.168.1.100 (old: 10.0.0.1)</td></tr>
</table></body></html>`
	...
	if info.Nodes[0].IP != "192.168.1.100" {
